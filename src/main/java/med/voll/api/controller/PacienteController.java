...
public class PacienteController {
    ...
    @GetMapping
    public Page<DadosListagemPaciente> listarPacientes(@PageableDefault(size = 10, sort = {"nome"}) Pageable paginacaoPaciente){
        return pacienteRepository.findAllByAtivoTrue(paginacaoPaciente).map(DadosListagemPaciente::new);
    }
